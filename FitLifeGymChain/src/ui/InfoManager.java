...
public class InfoManager {
    ...
    private static final String RAINY_FOREST_COMMAND = "rainy";
    ...
    private void printInstructions(){
        ...
        System.out.println("Enter '" + RAINY_FOREST_COMMAND + "' for Fitlife " + RAINY_FOREST_GYM_NAME);
        ...
        if (str.length() > 0) {
            switch (str) {
                ...
                case PALM_LAKE_COMMAND:
                    ...
                    break;
                case RAINY_FOREST_COMMAND:
                    printGymInfo(chain.lookupGymByName(RAINY_FOREST_GYM_NAME));
                    break;
